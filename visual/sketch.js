...
async function setup() {
  ...
  solarSystem.push(new Planet('./assets/eter.txt', 50, color(255, 251, 0)));
  solarSystem.push(new Planet('./assets/vortex.txt', 50, color(56, 113, 240)));
  solarSystem.push(new Planet('./assets/quimera.txt', 50, color(245, 99, 50)));
